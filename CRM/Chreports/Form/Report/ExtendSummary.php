...
{$this->_from} {$this->_where}";
  ...
  public function alterDisplay(&$rows) {
    ...
    foreach ($rows as $rowNum => $row) {
      if (!empty($row['civicrm_contribution_contribution_page_id'])) {
        $rows[$rowNum]['civicrm_contribution_contribution_page_id'] = $contributionPages[$row['civicrm_contribution_contribution_page_id']] ?? $row['civicrm_contribution_contribution_page_id'];
      }
    }
